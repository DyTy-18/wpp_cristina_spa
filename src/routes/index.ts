...
// Citas — Recordatorios de citas para Cristina Spa
routes.post(
  '/api/:session/citas/process-cita',
  verifyToken,
  statusConnection,
  CitasController.processCita
);
routes.post(
  '/api/:session/citas/send-reminder',
  verifyToken,
  statusConnection,
  CitasController.sendCitaReminder
);
routes.post(
  '/api/:session/citas/send-bulk-reminders',
  verifyToken,
  statusConnection,
  CitasController.sendBulkCitaReminders
);
routes.post(
  '/api/:session/citas/schedule-reminder',
  verifyToken,
  CitasController.scheduleCitaReminder
);
routes.get(
  '/api/:session/citas/active-conversations',
  verifyToken,
  CitasController.getActiveConversations
);
routes.get(
  '/api/:session/citas/scheduled-reminders',
  verifyToken,
  CitasController.getScheduledReminders
);
routes.delete(
  '/api/:session/citas/scheduled-reminders/:reminderId',
  verifyToken,
